//
//    Uso de funciones personalizadas de SNNCloud
//
"use strict";
/*-------------------------------------------
...
//
function LoadAjaxContent(url, origen, id){
...
$(document).ready(function () {
	...
	if (ajax_url.length < 1) {
        var rutaOrigen = location.pathname;
        var origen = rutaOrigen.split('/')[2];

        if(origen == 'admhome.html'){
            ajax_url = 'admhtml/inicio.html';
        } else {
            ajax_url = 'html/inicio.html';
        }
	}
    ...
    /*
    // Subir archivos - upload - comunicados
    mostrarArchivos();
...
function solicitados_tabla(){
    $('#solicitados').dataTable( {
...
function pdtactivar_tabla(){
    $('#pdtactivar').dataTable( {
...
function regTemporales(){
    $('#regTemporales').dataTable( {
...
/*** Tabla de servicios x Cliente desde Adm ****/
function serviciosCliente_tabla(){
    $('#serviciosCliente').dataTable( {
...
/*** Tabla de servicios x Cliente desde Adm ****/
function serviciosxCliente(){
    $('#tablaServiciosxCliente').dataTable( {
        "aaSorting": [[ 0, "asc" ]],
        "sDom": "<'box-content'<'col-sm-6'f><'col-sm-6 text-right'l><'clearfix'>>rt<'box-content'<'col-sm-6'i><'col-sm-6 text-right'p><'clearfix'>>",
        "sPaginationType": "bootstrap",
        "oLanguage": {
